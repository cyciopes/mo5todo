...
/**
 * Created by Jim.Lee on 2016/5/17.
 */
...
public class SpannableUtils {
    ...
    public static SpannableString setTextSize(String content, int startIndex, int endIndex, int fontSize ){
        ...
        spannableString.setSpan( new AbsoluteSizeSpan( fontSize,true ), startIndex, endIndex, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE );

        return spannableString;
    }

    public static SpannableString setTextSize(SpannableString span, int startIndex, int endIndex, int fontSize ){
        Log.i("MO5Todo","In SpannableString "+ span +" startIndex=" + startIndex+"  endIndex=" + endIndex);
//        if( TextUtils.isEmpty( span ) || fontSize <= 0 || startIndex >= endIndex || startIndex < 0 || endIndex >= span.length( ) ){
//            return null;
//        }
        span.setSpan( new AbsoluteSizeSpan( fontSize,true ), startIndex, endIndex, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE );
        return span;
    }
    ...
    public static SpannableString setTextForeground( SpannableString content, int startIndex, int endIndex, int foregroundColor ){

        content.setSpan(new ForegroundColorSpan( foregroundColor ), startIndex, endIndex, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
